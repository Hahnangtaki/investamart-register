...
public class AccountInstitutionRegister implements Serializable {
    ...
    @Column(name = "financial_asset_1", precision = 21, scale = 2)
    private BigDecimal financialAsset1;

    @Column(name = "financial_asset_2", precision = 21, scale = 2)
    private BigDecimal financialAsset2;

    @Column(name = "financial_asset_3", precision = 21, scale = 2)
    private BigDecimal financialAsset3;

    @Column(name = "operating_profit_1", precision = 21, scale = 2)
    private BigDecimal operatingProfit1;

    @Column(name = "operating_profit_2", precision = 21, scale = 2)
    private BigDecimal operatingProfit2;

    @Column(name = "operating_profit_3", precision = 21, scale = 2)
    ...
    public AccountInstitutionRegister financialAsset1(BigDecimal financialAsset1) {
    ...
    public AccountInstitutionRegister financialAsset2(BigDecimal financialAsset2) {
    ...
    public AccountInstitutionRegister financialAsset3(BigDecimal financialAsset3) {
    ...
    public AccountInstitutionRegister operatingProfit1(BigDecimal operatingProfit1) {
    ...
    public AccountInstitutionRegister operatingProfit2(BigDecimal operatingProfit2) {
    ...
    public AccountInstitutionRegister operatingProfit3(BigDecimal operatingProfit3) {
