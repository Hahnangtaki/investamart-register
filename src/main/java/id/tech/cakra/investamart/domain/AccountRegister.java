...
public class AccountRegister implements Serializable {
    ...
    @OneToOne(mappedBy = "accountRegister")
    @JsonIgnore
    ...
    public AccountRegister accountBanks(Set<AccountBank> accountBanks) {
        this.accountBanks = accountBanks;
        return this;
    }

    public AccountRegister addAccountBank(AccountBank accountBank) {
        this.accountBanks.add(accountBank);
        accountBank.setAccountRegister(this);
        return this;
    }

    public AccountRegister removeAccountBank(AccountBank accountBank) {
        this.accountBanks.remove(accountBank);
        accountBank.setAccountRegister(null);
        return this;
    }
