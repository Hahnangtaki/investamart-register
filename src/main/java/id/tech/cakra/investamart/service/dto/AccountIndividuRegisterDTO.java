...
/**
 * A DTO for the {@link id.tech.cakra.investamart.domain.AccountIndividuRegister} entity.
 */
public class AccountIndividuRegisterDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        AccountIndividuRegisterDTO accountIndividuRegisterDTO = (AccountIndividuRegisterDTO) o;
        if (accountIndividuRegisterDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), accountIndividuRegisterDTO.getId());
    }
    ...
    public String toString() {
        return "AccountIndividuRegisterDTO{" +
            "id=" + getId() +
            ", sid='" + getSid() + "'" +
