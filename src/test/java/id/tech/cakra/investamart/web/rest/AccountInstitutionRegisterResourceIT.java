...
public class AccountInstitutionRegisterResourceIT {
    ...
    public void createAccountInstitutionRegister() throws Exception {
        ...
        assertThat(testAccountInstitutionRegister.getCompanyEstablishPlace()).isEqualTo(DEFAULT_COMPANY_ESTABLISH_PLACE);
        ...
        assertThat(testAccountInstitutionRegister.getImageCertArticleAssociation()).isEqualTo(DEFAULT_IMAGE_CERT_ARTICLE_ASSOCIATION);
        assertThat(testAccountInstitutionRegister.getImageMgmtStructure()).isEqualTo(DEFAULT_IMAGE_MGMT_STRUCTURE);
        assertThat(testAccountInstitutionRegister.getImageSiup()).isEqualTo(DEFAULT_IMAGE_SIUP);
        assertThat(testAccountInstitutionRegister.getImageCertDomicile()).isEqualTo(DEFAULT_IMAGE_CERT_DOMICILE);
        assertThat(testAccountInstitutionRegister.getImageCertIncorporation()).isEqualTo(DEFAULT_IMAGE_CERT_INCORPORATION);
        assertThat(testAccountInstitutionRegister.getImageNPWP()).isEqualTo(DEFAULT_IMAGE_NPWP);
        assertThat(testAccountInstitutionRegister.getImageAuditedFinancial()).isEqualTo(DEFAULT_IMAGE_AUDITED_FINANCIAL);
        assertThat(testAccountInstitutionRegister.getImageShareHolder()).isEqualTo(DEFAULT_IMAGE_SHARE_HOLDER);
        assertThat(testAccountInstitutionRegister.getCompanyCharacteristicText()).isEqualTo(DEFAULT_COMPANY_CHARACTERISTIC_TEXT);
        assertThat(testAccountInstitutionRegister.getInvestmentObjectiveText()).isEqualTo(DEFAULT_INVESTMENT_OBJECTIVE_TEXT);
        assertThat(testAccountInstitutionRegister.getBussinessRegExpDate()).isEqualTo(DEFAULT_BUSSINESS_REG_EXP_DATE);
        assertThat(testAccountInstitutionRegister.getBusinessTypeText()).isEqualTo(DEFAULT_BUSINESS_TYPE_TEXT);
        assertThat(testAccountInstitutionRegister.getInvestExperience()).isEqualTo(DEFAULT_INVEST_EXPERIENCE);
        assertThat(testAccountInstitutionRegister.getInvestExperienceText()).isEqualTo(DEFAULT_INVEST_EXPERIENCE_TEXT);
        assertThat(testAccountInstitutionRegister.getBusinessFields()).isEqualTo(DEFAULT_BUSINESS_FIELDS);
        assertThat(testAccountInstitutionRegister.getBusinessFieldsText()).isEqualTo(DEFAULT_BUSINESS_FIELDS_TEXT);
        assertThat(testAccountInstitutionRegister.getCompanyDomicileStatus()).isEqualTo(DEFAULT_COMPANY_DOMICILE_STATUS);
        assertThat(testAccountInstitutionRegister.getCompanyDomicileSince()).isEqualTo(DEFAULT_COMPANY_DOMICILE_SINCE);
        assertThat(testAccountInstitutionRegister.getCompanyWebAddress()).isEqualTo(DEFAULT_COMPANY_WEB_ADDRESS);
        assertThat(testAccountInstitutionRegister.getCompanyEstablishCertificate()).isEqualTo(DEFAULT_COMPANY_ESTABLISH_CERTIFICATE);
    ...
    public void updateAccountInstitutionRegister() throws Exception {
        ...
        assertThat(testAccountInstitutionRegister.getCompanyEstablishPlace()).isEqualTo(UPDATED_COMPANY_ESTABLISH_PLACE);
        ...
        assertThat(testAccountInstitutionRegister.getImageCertArticleAssociation()).isEqualTo(UPDATED_IMAGE_CERT_ARTICLE_ASSOCIATION);
        assertThat(testAccountInstitutionRegister.getImageMgmtStructure()).isEqualTo(UPDATED_IMAGE_MGMT_STRUCTURE);
        assertThat(testAccountInstitutionRegister.getImageSiup()).isEqualTo(UPDATED_IMAGE_SIUP);
        assertThat(testAccountInstitutionRegister.getImageCertDomicile()).isEqualTo(UPDATED_IMAGE_CERT_DOMICILE);
        assertThat(testAccountInstitutionRegister.getImageCertIncorporation()).isEqualTo(UPDATED_IMAGE_CERT_INCORPORATION);
        assertThat(testAccountInstitutionRegister.getImageNPWP()).isEqualTo(UPDATED_IMAGE_NPWP);
        assertThat(testAccountInstitutionRegister.getImageAuditedFinancial()).isEqualTo(UPDATED_IMAGE_AUDITED_FINANCIAL);
        assertThat(testAccountInstitutionRegister.getImageShareHolder()).isEqualTo(UPDATED_IMAGE_SHARE_HOLDER);
        assertThat(testAccountInstitutionRegister.getCompanyCharacteristicText()).isEqualTo(UPDATED_COMPANY_CHARACTERISTIC_TEXT);
        assertThat(testAccountInstitutionRegister.getInvestmentObjectiveText()).isEqualTo(UPDATED_INVESTMENT_OBJECTIVE_TEXT);
        assertThat(testAccountInstitutionRegister.getBussinessRegExpDate()).isEqualTo(UPDATED_BUSSINESS_REG_EXP_DATE);
        assertThat(testAccountInstitutionRegister.getBusinessTypeText()).isEqualTo(UPDATED_BUSINESS_TYPE_TEXT);
        assertThat(testAccountInstitutionRegister.getInvestExperience()).isEqualTo(UPDATED_INVEST_EXPERIENCE);
        assertThat(testAccountInstitutionRegister.getInvestExperienceText()).isEqualTo(UPDATED_INVEST_EXPERIENCE_TEXT);
        assertThat(testAccountInstitutionRegister.getBusinessFields()).isEqualTo(UPDATED_BUSINESS_FIELDS);
        assertThat(testAccountInstitutionRegister.getBusinessFieldsText()).isEqualTo(UPDATED_BUSINESS_FIELDS_TEXT);
        assertThat(testAccountInstitutionRegister.getCompanyDomicileStatus()).isEqualTo(UPDATED_COMPANY_DOMICILE_STATUS);
        assertThat(testAccountInstitutionRegister.getCompanyDomicileSince()).isEqualTo(UPDATED_COMPANY_DOMICILE_SINCE);
        assertThat(testAccountInstitutionRegister.getCompanyWebAddress()).isEqualTo(UPDATED_COMPANY_WEB_ADDRESS);
        assertThat(testAccountInstitutionRegister.getCompanyEstablishCertificate()).isEqualTo(UPDATED_COMPANY_ESTABLISH_CERTIFICATE);
